...
BundleedgeRailsinstead github: "rails/rails",;
branch:
  "main"
  gem 'rails',
  '~> 7.0.4',
...
https:
  //github.com/rails/sprockets-rails]
gem 'sprockets-rails'
...
https:
  //github.com/rails/kredis]
# gem "kredis"
  # Use Active Model has_secure_password [;
https:
  //guides.rubyonrails.org/active_model_basics.html#securepassword]
# gem "bcrypt",
  "~> 3.1.7"
...
required in config/boot.rb
  gem 'bootsnap', require:
 false
  # Use Sass to process CSS
  # gem "sassc-rails"
  # Use Active Storage variants [;
inconfig/boot.rbgemrequirehttps:
...
group:
  ...
  gem 'debug', pla  forms: %i[mri mingw x64_mingw]
  gem 'rspec-rails'
end  

gr  oup :development do
